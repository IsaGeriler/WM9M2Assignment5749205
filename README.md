...
-	Meshes rendered into the game level
    * Data driven level loading, i.e. load the game meshes and data from a custom file format
    *	Opaque meshes
    *	Meshes such as grass which require alpha testing
    *	Mesh which includes vertex shader animation 
    *	Instancing of meshes such as trees
...
Note: Code will be commited at a later time, due to fixing a critical bug by "hard-coding".

https://github.com/user-attachments/assets/b6010296-162a-4411-b224-8e093ea0dcb0
